...
/**
 * InlineResponse2001Location Class Doc Comment
 *
 * @category Class
 ...
 */
class InlineResponse2001Location implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_1_location';
     ...
     * Sets zip
     *
     * @param string|null $zip Zipcode (Postleitzahl)
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city Pretty Print city name
     *
     * @return self
     */
