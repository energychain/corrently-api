...
export class EaseeApi {
     ...
     */
    public easeeSessions(username?: string, password?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: Array<models.EaseeCharger>;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/alternative/easee/lastSessions';
