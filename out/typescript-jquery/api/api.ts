...
export const APIS = [DispatchGreenEnergyDistributionAPIApi, EaseeApi, GreenPowerIndexGrnstromIndexApi, MeteringDecoratorApi, OcppApi, OpenMETERApi, SmartHomeApi, StromQuittungApi, StromkontoLedgerApi, TariffPriceAPIApi, WiMWechselprozesseImMesswesenStromStatusAPIApi];
