...
// APIClient manages communication with the Corrently.io API v2.0.0
...
type APIClient struct {
	...
	TariffPriceAPIApi *TariffPriceAPIApiService

	WiMWechselprozesseImMesswesenStromStatusAPIApi *WiMWechselprozesseImMesswesenStromStatusAPIApiService
}
