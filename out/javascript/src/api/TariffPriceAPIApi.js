...
export default class TariffPriceAPIApi {
    ...
    */
     ...
     * @param {String} opts.zipcode Zipcode (Postzleitzahl) of a city in Germany.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.zipcode Zipcode (Postzleitzahl) of a city in Germany.
     * @param {String} opts.email Valid email address to assign request to (pre offer generation). Ensure GDPR (DSGVO) at any time
     * @param {Number} opts.kwha Total amount of energy in kilo-watt-hours per year. (sample 2100)
     * @param {Number} opts.milliseconds If provided all results will be scaled to this timeframe
     * @param {Number} opts.wh If provided together with milliseconds, a cost component stament for a particular event (like charging a car) will be created.
