...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorrentlyIo.WiMWechselprozesseImMesswesenStromStatusAPIApi();
  });
  ...
  describe('WiMWechselprozesseImMesswesenStromStatusAPIApi', function() {
    describe('wimstatus', function() {
      it('should call wimstatus successfully', function(done) {
        //uncomment below and update the code to test wimstatus
        //instance.wimstatus(function(error) {
