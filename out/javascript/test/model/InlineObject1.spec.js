...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorrentlyIo.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new CorrentlyIo.InlineObject1();
      //expect(instance).to.be.a(CorrentlyIo.InlineObject1);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new CorrentlyIo.InlineObject1();
