...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorrentlyIo.InlineResponse2007();
  });
  ...
  describe('InlineResponse2007', function() {
    it('should create an instance of InlineResponse2007', function() {
      ...
      //var instane = new CorrentlyIo.InlineResponse2007();
      //expect(instance).to.be.a(CorrentlyIo.InlineResponse2007);
    });
    ...
    it('should have the property wimStatus (base name: "wim_status")', function() {
      ...
      //var instance = new CorrentlyIo.InlineResponse2007();
