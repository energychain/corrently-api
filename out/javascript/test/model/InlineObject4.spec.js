...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorrentlyIo.InlineObject4();
  });
  ...
  describe('InlineObject4', function() {
    it('should create an instance of InlineObject4', function() {
      ...
      //var instane = new CorrentlyIo.InlineObject4();
      //expect(instance).to.be.a(CorrentlyIo.InlineObject4);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new CorrentlyIo.InlineObject4();
