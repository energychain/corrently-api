...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorrentlyIo.Componentsh0();
  });
  ...
  describe('Componentsh0', function() {
    it('should create an instance of Componentsh0', function() {
      // uncomment below and update the code to test Componentsh0
      //var instane = new CorrentlyIo.Componentsh0();
      //expect(instance).to.be.a(CorrentlyIo.Componentsh0);
    });

    it('should have the property sum (base name: "sum")', function() {
      // uncomment below and update the code to test the property sum
      //var instance = new CorrentlyIo.Componentsh0();
      //expect(instance).to.be();
    });

    it('should have the property describtion (base name: "describtion")', function() {
      // uncomment below and update the code to test the property describtion
      //var instance = new CorrentlyIo.Componentsh0();
      //expect(instance).to.be();
    });

    it('should have the property mutlityplier (base name: "mutlityplier")', function() {
      // uncomment below and update the code to test the property mutlityplier
      //var instance = new CorrentlyIo.Componentsh0();
      //expect(instance).to.be();
    });
