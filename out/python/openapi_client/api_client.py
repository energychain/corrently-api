...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DispatchGreenEnergyDistributionAPIApi()
        api_instance.gsi_dispatch  # this is an instance of the class Endpoint
        api_instance.gsi_dispatch()  # this invokes api_instance.gsi_dispatch.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.gsi_dispatch.callable or self.callable in this class
