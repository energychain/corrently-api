...
export class Ommeters {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "currentScalingFactor",
            "baseName": "currentScalingFactor",
            "type": "number",
            "format": ""
        },
        {
            "name": "voltageScalingFactor",
            "baseName": "voltageScalingFactor",
            "type": "number",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return Ommeters.attributeTypeMap;
    }
